...
| room-invite | `string` | Emit when there is a room invitation, see more in  [RoomInvitation](https://github.com/lijiarui/wechaty-docs/tree/0fdb8c93dc58cc13bdf1c01d120c9b2b4557684c/root/wechaty/api/RoomInvitation/README.md)                                    If someone leaves the room by themselves, wechat will not notice other people in the room, so the bot will never get the "leave" event. |
...
| room-invite | `function` | \(this: Wechaty, room: Room, leaverList: Contact\[\]\) =&gt; void                                          see more in  [RoomInvitation](https://github.com/lijiarui/wechaty-docs/tree/0fdb8c93dc58cc13bdf1c01d120c9b2b4557684c/root/wechaty/api/RoomInvitation/README.md) |
